      ...
      <section className="md:container lg:w-1/2 md:mx-auto md:my-20 shadow rounded-xl">
        ...
        >
          ...
          <section className="grid md:grid-cols-2 gap-2.5">
            ...
            <div>
              <p className="mb-2 font-semibold text-sm">Preferred Doctor</p>
              <TextField
            ...
            <div>
              <p className="mb-2 font-semibold text-sm">Payment Type</p>
              <TextField
            ...
            <div>
              <p className="mb-2 font-semibold text-sm">Specific Concern</p>
              <TextField
